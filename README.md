...
<p align="center">
  <a href="https://github.com/glowseedstudio/Vantafyn/releases/tag/v0.9.16"><img src="https://img.shields.io/badge/Release-v0.9.16-21D8FF.svg?style=flat-square" alt="Version 0.9.16" /></a>
...
<p align="center">
  <a href="https://github.com/glowseedstudio/Vantafyn/releases/tag/v0.9.16"><strong>⬇️ Download Latest APK (v0.9.16)</strong></a> &nbsp;•&nbsp;
...
### Direct Download
Production minified APKs are available on the **[Releases Page](https://github.com/glowseedstudio/Vantafyn/releases/tag/v0.9.16)**:
- **Phone / Tablet / Auto**: [`app-mobile-release.apk`](https://github.com/glowseedstudio/Vantafyn/releases/download/v0.9.16/app-mobile-release.apk) *(61 MB, R8-shrunk)*
- **Android TV**: [`app-tv-release.apk`](https://github.com/glowseedstudio/Vantafyn/releases/download/v0.9.16/app-tv-release.apk) *(24 MB)*
