...
| :--- | :---: | :--- |
| **Vantafyn Mobile (Phone/Tablet/Auto)** | `>= 0.9.22` | :white_check_mark: Supported |
| **Vantafyn Android TV** | `>= 0.9.22` | :white_check_mark: Supported |
| **Vantafyn Companion Plugin** | `>= 0.1.1` | :white_check_mark: Supported |
| `< 0.9.22` | Older builds | :x: Unsupported (Upgrade recommended) |
